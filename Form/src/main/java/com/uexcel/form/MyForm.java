...
public class MyForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(250, 170, 80, 27);

        jTextField1.setDragEnabled(true);
        jPanel1.add(jTextField1);
        jTextField1.setBounds(110, 70, 220, 30);
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(20, 120, 100, 30);
        ...
        jButton2.setBounds(110, 170, 80, 27);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       this.dispose();
        Form2 form2 = new Form2(jTextField1.getText());
        form2.setVisible(rootPaneCheckingEnabled);
//        JOptionPane.showMessageDialog(this, "Welcome " + jTextField1.getText(), "Home", JOptionPane.INFORMATION_MESSAGE);
