        ...
        <div class= "outer">
            <div class="txt">
                <form action="blog" method="post">
                    ...
                    <p><input name="title" size="50" placeholder="Write blog title here" required="on"></P>
                    <p><input name="author" size="50" value="Published by ${fName} ${lName}" placeholder="Write blog title here" required="on"></P>
                    <textarea name="textArea"  placeholder="Write your blog here" rows="40" cols="100" class="area" ></textarea>
                </form>
            </div>
        </div>
    </body>
